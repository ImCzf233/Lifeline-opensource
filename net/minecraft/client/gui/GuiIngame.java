...
import wtf.lifeline.events.rendering.EventDrawText;
import wtf.lifeline.events.rendering.EventRender2D;
import wtf.lifeline.module.ModuleManager;
import wtf.lifeline.module.modules.render.HUD;
import wtf.lifeline.utils.render.ColorUtils;
...
public class GuiIngame extends Gui
{
    ...
    {
        wtf.lifeline.module.modules.render.Scoreboard scoreboard23 = (wtf.lifeline.module.modules.render.Scoreboard) Client.instance.getModuleManager().getModuleByClass(wtf.lifeline.module.modules.render.Scoreboard.class);
        ...
        for (Object score1 : arraylist1) {
            ...
            if (scoreboard23.serverip.getValue()) {
                if (s1.contains("mc.remiaft.com") ||
                    ...
                    if (wtf.lifeline.module.modules.render.Scoreboard.serveripm.getValue() == wtf.lifeline.module.modules.render.Scoreboard.serverIPMode.Normal) {
            ...
            if (wtf.lifeline.module.modules.render.Scoreboard.serveripm.getValue() == wtf.lifeline.module.modules.render.Scoreboard.serverIPMode.Rainbow) {
                this.getFontRenderer().drawString(s1, j, l, ColorUtils.fastrainbow().getRGB());
            }
            else {
