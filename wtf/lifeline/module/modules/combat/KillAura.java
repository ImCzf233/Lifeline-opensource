...
import wtf.lifeline.utils.render.AnimationUtils;
...
import wtf.lifeline.gui.font.CFont;
...
public class KillAura
    ...
    private final wtf.lifeline.module.value.Mode<Enum> Mode = new Mode<Enum>("Mode", "Mode", AuraMode.values(), AuraMode.Single);
    private final Mode<Enum> thudMode = new Mode<Enum>("THUDStyle", "TargetHudStyle", THUDMode.values(), THUDMode.Client);
