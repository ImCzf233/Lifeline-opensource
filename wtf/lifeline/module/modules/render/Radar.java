...
import wtf.lifeline.event.impl.render.ShaderEvent;
import wtf.lifeline.settings.impl.*;
import wtf.lifeline.utils.misc.MathUtils;
import wtf.lifeline.utils.objects.Drag;
import wtf.lifeline.utils.render.*;
import wtf.lifeline.utils.render.ColorUtil;
import wtf.lifeline.utils.render.GLUtil;
import wtf.lifeline.utils.render.StencilUtil;
...
public class Radar extends Module {
    ...
    private final ColorSetting color1 = new ColorSetting("Color 1", Client.instance.getClientColor());
    private final ColorSetting color2 = new ColorSetting("Color 2", Client.instance.getAlternateClientColor());
    ...
    public Radar() {
        super("Radar", new String[]{}, Category.RENDER);
    ...
    private final EventListener<Render2DEvent> render2DEvent = e -> {
        ...
        switch (colorMode.getMode()) {
            case "Sync":
                ...
                break;
            case "LIFELINE":
                gradientColor1 = ColorUtil.interpolateColorsBackAndForth(15, 0, Client.instance.getClientColor(), Client.instance.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                gradientColor2 = ColorUtil.interpolateColorsBackAndForth(15, 90, Client.instance.getClientColor(), Client.instance.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                gradientColor3 = ColorUtil.interpolateColorsBackAndForth(15, 180, Client.instance.getClientColor(), Client.instance.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                gradientColor4 = ColorUtil.interpolateColorsBackAndForth(15, 270, Client.instance.getClientColor(), Client.instance.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                break;
            case "Gradient":
