...
import wtf.lifeline.utils.RoundedUtil;
import wtf.lifeline.utils.StencilUtil;
import wtf.lifeline.utils.color.Colors;
...
public class SessionStats extends Module {
    ...
    public SessionStats() {
        super("Session", new String[]{}, Category.RENDER);
        addValues(posX,posY);
    }
