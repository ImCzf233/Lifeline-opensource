...
import wtf.lifeline.events.world.EventLivingUpdate;
...
import wtf.lifeline.utils.Particles;
import wtf.lifeline.utils.render.RenderUtil;
import wtf.lifeline.utils.sub.Location;
...
public class DMGParticle extends Module
{
    ...
    public DMGParticle() {
        super("DMGParticle", new String[] {"DamageParticle"}, Category.RENDER);
