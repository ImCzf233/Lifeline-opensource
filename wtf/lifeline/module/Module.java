...
import wtf.lifeline.utils.render.Translate;
   ...
   public void setEnabled(boolean enabled) {
      ...
      if(enabled) {
         ...
         if (Minecraft.theWorld != null) {
             ...
             NoticeNotification.send("Module Information","Enabled " + this.getName() , NoticeNotification.Type.SUCCESS);
         }
    	  ...
    	  if (Minecraft.theWorld != null) {
              Minecraft.thePlayer.playSound("random.click", 0.2f, this.enabled ? 0.6f : 0.5f);
              NoticeNotification.send("Module Information", "Disabled " + this.getName() , NoticeNotification.Type.ERROR);
          }
