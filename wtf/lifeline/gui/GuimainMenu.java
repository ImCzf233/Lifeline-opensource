...
import wtf.lifeline.gui.login.Alt;
import wtf.lifeline.gui.login.GuiAltManager;
import wtf.lifeline.utils.ParticleEngine;
...
public class GuimainMenu extends GuiScreen implements GuiYesNoCallback{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontLoaders.GBD30.drawString(" Power by LIFELINE Dev Group", 5, sr.getScaledHeight() - 5 - FontLoaders.GBD30.getHeight() + 1, -1);

        FontLoaders.GBD30.drawString("Minecraft 1.8.8 / LIFELINE 1.0", sr.getScaledWidth() - 5 - 0.5f - FontLoaders.GBD30.getStringWidth("Minecraft 1.8.8 / LIFELINE 1.0") + 1, sr.getScaledHeight() - 5 - FontLoaders.GBD30.getHeight() + 1, -1);
